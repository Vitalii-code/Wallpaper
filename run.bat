...
if not exist "python\" (
	...
	start /WAIT /b downloader\aria2c.exe "https://www.python.org/ftp/python/3.9.13/python-3.9.13-embed-amd64.zip" -o "python.zip" < NUL
    ...
    start /WAIT /b downloader\aria2c.exe "https://bootstrap.pypa.io/get-pip.py" -o "python\get-pip.py" < NUL
